...
export class UnitComponent implements OnInit {
  ...
  errors: any = {};
  searchInput: string = "";
  constructor(private modalService: NgbModal,private _unit:UnitservService,public _router: Router,
  ...
  changeOp(e:any){
    this.createunit.get('operator').setValue(e.target.value,{onlySelf:true})
  }
  changeBase(e:any){
    this.createunit.get('operator_value').setValue(e.target.value,{onlySelf:true})
  }
  ...
  AllData() {
    ...
    editUnit(id: number) {
      ...
      this.editUnitForm.get("operator_value").setValue(this.unitForEdit.operator_value);
      },
      error: (error) => {
      console.log(error);
      },
      ...
      updateUnit() {
        ...
        this._unit.updateUnit(this.unitForEdit?.id, this.editUnitForm.value)
        .subscribe(observer);
        } 
        deleteUnit(id: any) {
          console.log(id);
